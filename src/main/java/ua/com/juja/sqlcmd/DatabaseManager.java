...
public class DatabaseManager {
    ...
    public String[] getTableNames() {
        try {
            Statement stmt = connection.createStatement();
            ResultSet rs = stmt.executeQuery(" SELECT table_name FROM information_schema.tables WHERE table_schema = 'sqlcmd'");
    ...
    public void create(DataSet input) {
        try {
            ...
            stmt.executeUpdate("INSERT INTO user (" + tableNames + ")" +
                    " VALUES (" + values + ")");
            stmt.close();
        } catch (SQLException e) {
            e.printStackTrace();
    ...
    private String getNamesFormated(DataSet newValue, String s) {
        String string = "";
